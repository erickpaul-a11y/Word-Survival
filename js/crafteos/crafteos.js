class Crafteos {
    ...
    iniciar(){this.receta('2 madera → 4 palos',{madera:2},'palo',4);this.receta('3 piedra + 2 madera → pico',{piedra:3,madera:2},'pico',1);this.receta('3 piedra + 3 madera → hacha',{piedra:3,madera:3},'hacha',1);}

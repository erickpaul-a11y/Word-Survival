class Jugador {
    constructor(){
        ...
        const head=new THREE.Mesh(new THREE.BoxGeometry(.55,.55,.55),mat);head.name='head';head.position.y=1.48;this.modelo.add(head);
    ...
    actualizarManoIzquierda(cam,activo){this.leftHandHeld=activo;if(!cam||!this.leftArm)return;this.leftArm.rotation.z=activo?.55:.08;this.leftArm.rotation.x=activo?cam.rotation.x*.35:0;this.leftArm.rotation.y=activo?cam.rotation.y*.25:0;this.leftArm.position.z=activo?-.18:0;}

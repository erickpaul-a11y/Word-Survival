class Jugador {
    ...
    seguirMouse(cam,activaIzquierda,activaDerecha){if(!cam)return;const sensibilidad=.9;const objetivoX=Math.max(-1.25,Math.min(1.25,cam.rotation.x*sensibilidad));const objetivoY=Math.max(-1.1,Math.min(1.1,cam.rotation.y*sensibilidad));if(activaIzquierda){this.leftArm.rotation.x+=(objetivoX-this.leftArm.rotation.x)*.18;this.leftArm.rotation.y+=(objetivoY-this.leftArm.rotation.y)*.18;this.leftArm.rotation.z+=((.55)-this.leftArm.rotation.z)*.18;}else{this.leftArm.rotation.x*=.85;this.leftArm.rotation.y*=.85;this.leftArm.rotation.z+=((.08)-this.leftArm.rotation.z)*.18;}if(activaDerecha){this.rightArm.rotation.x+=(objetivoX-this.rightArm.rotation.x)*.18;this.rightArm.rotation.y+=(objetivoY-this.rightArm.rotation.y)*.18;this.rightArm.rotation.z+=((-.55)-this.rightArm.rotation.z)*.18;}else{this.rightArm.rotation.x*=.85;this.rightArm.rotation.y*=.85;this.rightArm.rotation.z+=((-.08)-this.rightArm.rotation.z)*.18;}}

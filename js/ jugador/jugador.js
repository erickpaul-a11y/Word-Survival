class Jugador {
    constructor() {
        ...
        this.modelo = new THREE.Mesh(new THREE.BoxGeometry(0.8,1.8,0.8), new THREE.MeshLambertMaterial({color:0x22c55e}));
        this.modelo.position.y = 0.9;
    }
    agregarAEscena(e) { e.add(this.modelo); }
    actualizarPosicion() { this.modelo.position.set(this.x, this.y-0.9, this.z); }
    actualizarHUD() {
